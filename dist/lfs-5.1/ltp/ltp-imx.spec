...
Source2         : %{name}_0001_vte_source_%{vte_version}.tar.gz
Source3         : %{name}_0002_open_module_test_%{vte_version}.tar.gz
Source4         : %{name}_0003_vte_module_test_%{vte_version}.tar.gz
Source5         : %{name}_0004_vte_test_data_%{vte_version}.tar.gz
Source6         : %{name}_0005_add_module_test_%{vte_version}.tar.gz
Source7         : %{name}_0006_add_top_makefile_%{vte_version}.tar.gz
Source8         : %{name}_0007_add_armconfig_%{vte_version}.tar.gz
...
%Prep
%setup -n ltp-full-%{version} -a1 -a2 -a3 -a4 -a5 -a6 -a7 -a8
